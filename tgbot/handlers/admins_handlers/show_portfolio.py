...
from tgbot.keyboards.admin.inlinekeyboard.portfolio_ikb import get_items_keyboard, item_callback
...
def register_show_portfolio_admin_handlers(dp: Dispatcher):
    ...
    dp.register_callback_query_handler(item_page_handler, AdminFilter(), item_callback.filter())